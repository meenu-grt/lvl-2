  ...
  return (
    <div className="panel-grid">
      ...
      <div className="glass-card glass-card--wide">
        ...
        {phase === 'working' && (
          <p className="status-line status-line--working">Building a zero-knowledge proof locally, then waiting for confirmation…</p>
        )}
        {phase === 'confirmed' && txId && (
          <p className="status-line status-line--ok" title={txId}>
